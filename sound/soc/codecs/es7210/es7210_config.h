...
#define RATIO_MCLK_LRCK  RATIO_MCLK_LRCK_128

#define ES7210_I2C_BUS_NUM              7
...
static const struct es7210_reg_config es7210_tdm_reg_common_cfg1[] = {
	/* stock probe writes [00]=0x71 then 0x41 (no FF/32 pre-sequence) */
	{0x09, 0x30},
	{0x0A, 0x30},
	{0x23, 0x2a},
	{0x22, 0x0a},
...
static const struct es7210_reg_config es7210_tdm_reg_common_cfg2[] = {
	/* stock probe never writes ANALOG_SYS[0x40] - it stays 0x46 */
	{0x41, 0x70},
	{0x42, 0x70},
	{0x43, 0x1a},
	{0x44, 0x1a},
