...
# MediaTek platform name used by hundreds of mediatek Makefiles
# (originally exported by the alps build system). Default to mt6771
# so this tree builds standalone; can still be overridden externally.
export MTK_PLATFORM ?= mt6771
...
# MediaTek alps code references headers across module directories with
# angled includes; the alps build system used to supply these paths.
MTKINCLUDES	:= \
		-I$(srctree)/drivers/misc/mediatek/include \
		-I$(srctree)/drivers/misc/mediatek/base/power/$(MTK_PLATFORM) \
		-I$(srctree)/drivers/misc/mediatek/base/power/include \
		-I$(srctree)/drivers/misc/mediatek/base/power/spm_v4 \
		-I$(srctree)/drivers/misc/mediatek/base/power/swpm_v1/$(MTK_PLATFORM) \
		-I$(srctree)/drivers/misc/mediatek/base/power/ppm_v3/inc \
		-I$(srctree)/drivers/misc/mediatek/base/power/ppm_v3/src/mach/$(MTK_PLATFORM) \
		-I$(srctree)/drivers/misc/mediatek/mmdvfs \
		-I$(srctree)/drivers/misc/mediatek/ccu/src/2.0 \
		-I$(srctree)/drivers/misc/mediatek/ccu/src/$(MTK_PLATFORM) \
		-I$(srctree)/drivers/misc/mediatek/ccu/src/$(MTK_PLATFORM)/ccu_ext_interface \
		-I$(srctree)/drivers/misc/mediatek/cmdq/v3 \
		-I$(srctree)/drivers/misc/mediatek/cmdq/v3/$(MTK_PLATFORM) \
		-I$(srctree)/drivers/misc/mediatek/debug_latch/plat_dbg_info \
		-I$(srctree)/drivers/misc/mediatek/emi/$(MTK_PLATFORM) \
		...
		-I$(srctree)/drivers/misc/mediatek/m4u/2.4 \
		...
		-I$(srctree)/drivers/misc/mediatek/tee_sanity \
		-I$(srctree)/drivers/misc/mediatek/typec/tcpc \
		-I$(srctree)/drivers/misc/mediatek/video/include \
		-I$(srctree)/drivers/misc/mediatek/video/$(MTK_PLATFORM)/dispsys \
		-I$(srctree)/drivers/misc/mediatek/video/$(MTK_PLATFORM)/videox \
		-I$(srctree)/drivers/misc/mediatek/video/common/layering_rule_base/v1.1 \
		-I$(srctree)/drivers/phy/mediatek \
		-I$(srctree)/drivers/pinctrl/mediatek \
		-I$(srctree)/drivers/power/supply/mediatek/battery \
		-I$(srctree)/drivers/scsi/ufs \
		-I$(srctree)/drivers/scsi/ufs/mediatek/$(MTK_PLATFORM) \
		-I$(srctree)/drivers/staging/android/ion \
		-I$(srctree)/drivers/watchdog/mediatek/include \
