 ...
 * Filename:
 * ---------
 *	 s5k3l6mipiraw_Sensor.h
 *
 ****************************************************************************/
#ifndef _S5K3L6MIPI_SENSOR_H
#define _S5K3L6MIPI_SENSOR_H
...
*/
extern bool update_3l6_eepromInfo(void);
extern int read_eeprom_s5k3l6(u16 addr, BYTE* data, u32 size );
