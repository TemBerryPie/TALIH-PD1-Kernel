...
static int tv110xum_lcm_vgp_supply_enable(void)
{
	int ret;
	unsigned int volt;
...
static int tv110xum_lcm_vgp_supply_disable(void)
{
	int ret = 0;
...
static void tv110xum_lcm_request_gpio_control(struct device *dev)
{
...
static int lcm_driver_probe(struct device *dev, void const *data)
{
	...
	tv110xum_lcm_request_gpio_control(dev);
...
static void __maybe_unused lcm_initial_registers(void)
{
	unsigned int data_array[16];

	/* [0] long write 0x39, 4 bytes */
	data_array[0] = 0x00043902;
	data_array[1] = 0x2E1083B9;
	dsi_set_cmdq(data_array, 2, 1);

	/* [1] long write 0x39, 5 bytes */
	data_array[0] = 0x00053902;
	data_array[1] = 0xFF0C67D1;
	data_array[2] = 0x00000005;
	dsi_set_cmdq(data_array, 3, 1);

	/* [2] long write 0x39, 18 bytes */
	...
	/* [3] long write 0x39, 3 bytes */
	data_array[0] = 0x00033902;
	data_array[1] = 0x002B2BD2;
	dsi_set_cmdq(data_array, 2, 1);

	/* [4] long write 0x39, 17 bytes */
	...
	/* [5] short write 0x15: BD 03 */
	data_array[0] = 0x03BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [6] short write 0x15: B2 80 */
	data_array[0] = 0x80B21502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [7] short write 0x15: BD 00 */
	data_array[0] = 0x00BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [8] long write 0x39, 17 bytes */
	data_array[0] = 0x00113902;
	...
	/* [9] short write 0x15: E9 CD */
	data_array[0] = 0xCDE91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [10] short write 0x15: BB 01 */
	data_array[0] = 0x01BB1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [11] short write 0x15: E9 00 */
	data_array[0] = 0x00E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [12] long write 0x39, 4 bytes */
	data_array[0] = 0x00043902;
	data_array[1] = 0x8085FCBF;
	dsi_set_cmdq(data_array, 2, 1);

	/* [13] long write 0x39, 9 bytes */
	...
	/* [15] short write 0x15: E9 D7 */
	data_array[0] = 0xD7E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [16] long write 0x39, 22 bytes */
	...
	/* [17] short write 0x15: E9 00 */
	data_array[0] = 0x00E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [18] long write 0x39, 24 bytes */
	...
	/* [19] short write 0x15: E9 D8 */
	data_array[0] = 0xD8E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [20] long write 0x39, 24 bytes */
	data_array[0] = 0x00183902;
	data_array[1] = 0x080200E0;
	data_array[2] = 0x2816110C;
	data_array[3] = 0x432C312C;
	...
	/* [21] short write 0x15: E9 00 */
	data_array[0] = 0x00E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [22] short write 0x15: BD 01 */
	data_array[0] = 0x01BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [23] long write 0x39, 5 bytes */
	data_array[0] = 0x00053902;
	data_array[1] = 0x019B01B1;
	data_array[2] = 0x00000031;
	dsi_set_cmdq(data_array, 3, 1);

	/* [24] long write 0x39, 11 bytes */
	...
	/* [26] short write 0x15: BD 02 */
	data_array[0] = 0x02BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [27] long write 0x39, 7 bytes */
	data_array[0] = 0x00073902;
	data_array[1] = 0x33004EB4;
	data_array[2] = 0x00883311;
	dsi_set_cmdq(data_array, 3, 1);

	/* [28] long write 0x39, 4 bytes */
	data_array[0] = 0x00043902;
	data_array[1] = 0x0200F2BF;
	dsi_set_cmdq(data_array, 2, 1);

	/* [29] short write 0x15: BD 00 */
	data_array[0] = 0x00BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [30] long write 0x39, 15 bytes */
	...
	/* [32] long write 0x39, 4 bytes */
	data_array[0] = 0x00043902;
	data_array[1] = 0x050407D0;
	dsi_set_cmdq(data_array, 2, 1);

	/* [33] long write 0x39, 23 bytes */
	data_array[0] = 0x00173902;
	...
	/* [34] short write 0x15: E9 D7 */
	data_array[0] = 0xD7E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [35] long write 0x39, 23 bytes */
	data_array[0] = 0x00173902;
	...
	/* [36] short write 0x15: E9 00 */
	data_array[0] = 0x00E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [37] long write 0x39, 23 bytes */
	data_array[0] = 0x00173902;
	...
	/* [38] short write 0x15: E9 D7 */
	data_array[0] = 0xD7E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [39] long write 0x39, 23 bytes */
	data_array[0] = 0x00173902;
	...
	/* [40] short write 0x15: E9 00 */
	data_array[0] = 0x00E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [41] long write 0x39, 23 bytes */
	data_array[0] = 0x00173902;
	...
	/* [42] short write 0x15: BD 01 */
	data_array[0] = 0x01BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [43] long write 0x39, 8 bytes */
	data_array[0] = 0x00083902;
	data_array[1] = 0x015002E7;
	data_array[2] = 0x0EF00DA0;
	dsi_set_cmdq(data_array, 3, 1);

	/* [44] short write 0x15: BD 02 */
	data_array[0] = 0x02BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [45] long write 0x39, 23 bytes */
	data_array[0] = 0x00173902;
	...
	/* [46] short write 0x15: E9 D7 */
	data_array[0] = 0xD7E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [47] long write 0x39, 7 bytes */
	data_array[0] = 0x00073902;
	data_array[1] = 0x810000E7;
	data_array[2] = 0x00400200;
	dsi_set_cmdq(data_array, 3, 1);

	/* [48] short write 0x15: E9 00 */
	data_array[0] = 0x00E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [49] short write 0x15: BD 00 */
	data_array[0] = 0x00BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [50] short write 0x15: BD 02 */
	data_array[0] = 0x02BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [51] long write 0x39, 13 bytes */
	...
	/* [52] short write 0x15: BD 03 */
	data_array[0] = 0x03BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [53] long write 0x39, 23 bytes */
	data_array[0] = 0x00173902;
	...
	/* [54] short write 0x15: E9 D7 */
	data_array[0] = 0xD7E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [55] long write 0x39, 3 bytes */
	data_array[0] = 0x00033902;
	data_array[1] = 0x005555D8;
	dsi_set_cmdq(data_array, 2, 1);

	/* [56] short write 0x15: E9 00 */
	data_array[0] = 0x00E91502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [57] short write 0x15: BD 00 */
	data_array[0] = 0x00BD1502;
	dsi_set_cmdq(data_array, 1, 1);

	/* [58] short write 0x15: CC 02 */
...
static void lcm_init(void)
{
	...
	tv110xum_lcm_vgp_supply_enable();
	MDELAY(3);
...
static void lcm_suspend(void)
{
	...
	tv110xum_lcm_vgp_supply_disable();
	LCM_LOGI("[Kernel/LCM] %s exit\n", __func__);
}
...
struct LCM_DRIVER tv110xum_lb2_incell_v2_lcm_drv = {
	.name = "tv110xum_lb2_incell_v2",
