...
static inline struct file *ksu_anon_inode_create_getfile_compat(const char *name,
...
{
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 15, 0) && LINUX_VERSION_CODE < KERNEL_VERSION(5, 16, 0)
